  ...
  el.innerHTML = `
    <article class="asset-card asset-card-total">
      ...
      <p class="asset-card-note">${periodCaption}</p>
        ...
        <p><span>運用増減率</span><strong class="${valueToneClass(summary.operation_change_rate)}">${summary.operation_change_rate === null || summary.operation_change_rate === undefined ? '--' : formatSignedPercent(summary.operation_change_rate)}</strong></p>
